...
import kotlinx.android.synthetic.main.item_cart.view.ivProduct
import kotlinx.android.synthetic.main.item_cart.view.tvOriginalPrice
import kotlinx.android.synthetic.main.item_cart.view.tvProductName
                ...
                if (it.size == 0) {
                    ...
                    if (activity != null) {
                        ...
                        for (i in 0 until it.size) {
                            ...
                            itemData.product_id = it[i].pro_id
