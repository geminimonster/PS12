...
import com.iqonic.store.ProShopApp.Companion.noInternetDialog
...
open class AppBaseActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        switchToDarkMode(ProShopApp.appTheme == DARK)
        super.onCreate(savedInstanceState)
        ProShopApp.mAppDataChanges()
    ...
    override fun onResume() {
        super.onResume()
        val locale = Locale(ProShopApp.language)
        val appTheme = ProShopApp.appTheme
